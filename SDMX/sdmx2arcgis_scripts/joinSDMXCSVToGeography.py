...
in_sdmx_csv = arcpy.GetParameterAsText(0)
...
in_output_filename = arcpy.ValidateTableName(arcpy.GetParameterAsText(10))
...
arcpy.TableToTable_conversion(in_sdmx_csv, 'memory', tmp_stats_tbl)
